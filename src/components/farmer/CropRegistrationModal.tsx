      ...
      <div className="bg-white rounded-xl max-w-md w-full p-4 sm:p-5 shadow-xl space-y-3.5 animate-in fade-in zoom-in-95 border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            ...
            <input type="text" value={variety} onChange={(e) => setVariety(e.target.value)} required className="w-full rounded border border-slate-300 px-2.5 py-1.5 text-xs text-slate-900 focus:outline-none focus:border-emerald-600" />
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {(["Sowing", "Vegetative Growth", "Flowering", "Harvest Ready"] as CropStage[]).map((stg) => (
